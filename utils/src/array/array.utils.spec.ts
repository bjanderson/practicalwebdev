...
describe('array.utils', function() {
  ...
  describe('getArrayOfBooleans(objs)', function() {
    it('is a function', function() {
      expect(typeof getArrayOfBooleans).toEqual('function');
    });

    it('returns an empty array when the input is undefined', function() {
      const expected: any = [];
      const result: any = getArrayOfBooleans(undefined);
      expect(result).toEqual(expected);
    });

    it('returns an empty array when the input is null', function() {
      const expected: any = [];
      const result: any = getArrayOfBooleans(null);
      expect(result).toEqual(expected);
    });

    it('returns an array when the input is a single object', function() {
      const expected: any = [true];
      const result: any = getArrayOfBooleans('true');
      expect(result).toEqual(expected);
    });

    it('returns an array of booleans when the input is an array of items that can be converted to booleans', function() {
    ...
    it('excludes null and undefined values from the returned array', function() {
  ...
  describe('getArrayOfNumbers(objs)', function() {
    it('is a function', function() {
    ...
    it('returns an array of numbers when the input is an array of items that can be converted to numbers', function() {
  ...
  describe('getArrayOfStrings(objs)', function() {
    it('is a function', function() {
    ...
    it('returns an array of strings when the input is an array of items that can be converted to strings', function() {
    ...
    it('returns an array of empty strings for any input array elements that cannot be safely converted to a string', function() {
